      ...
      <section className="py-24 px-6 md:px-12 bg-[#0a0a0a] border-b border-[#212327]">
        <div className="max-w-7xl mx-auto space-y-24">
          {SERVICES_DETAILED.map((svc) => (
            <div key={svc.category} className="border-t border-[#212327] pt-12 flex flex-col md:flex-row gap-12 lg:gap-24">
              ...
              <div className="md:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-12">
                <div>
                  <h4 className="font-mono text-xs text-[#7d8187] mb-3 uppercase tracking-wider">Context</h4>
                  <p className="text-[#7d8187] leading-relaxed text-sm">{svc.context}</p>
                </div>
                <div>
                  <h4 className="font-mono text-xs text-[#7d8187] mb-3 uppercase tracking-wider">Deliverable</h4>
                  <p className="text-[#7d8187] leading-relaxed text-sm">{svc.deliverable}</p>
                </div>
                <div className="md:col-span-2 pt-4 border-t border-[#212327]">
                  <h4 className="font-mono text-xs text-[#7d8187] mb-3 uppercase tracking-wider">Expected Output</h4>
                  <p className="text-white text-base leading-relaxed tracking-normal">{svc.output}</p>
                </div>
              </div>
            </div>
          ))}
