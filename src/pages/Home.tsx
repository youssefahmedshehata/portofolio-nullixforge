  ...
  return (
    <div className="relative pt-24 pb-12 w-full max-w-7xl mx-auto px-6 md:px-12 z-10" data-scene="home-void">
      ...
      <section className="mb-40 relative">
        ...
        <div className="rounded-[32px] p-8 md:p-16 relative flex flex-col md:flex-row gap-12 border border-white/[0.12] bg-[linear-gradient(135deg,rgba(18,19,22,0.98),rgba(7,8,10,1))]">
      ...
      <section id="contact-form-section" className="mb-20">
        <div className="flex flex-col md:flex-row gap-12 max-w-5xl mx-auto rounded-[32px] p-8 md:p-12 bg-[#0A0B0E]/98 border border-white/[0.12]">
