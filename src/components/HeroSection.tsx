...
export function HeroSection() {
  return (
    <section className="min-h-screen flex flex-col justify-center px-6 md:px-12 pt-32 pb-24 relative overflow-hidden">
      {/* Vercel-style Atmospheric Mesh Gradient */}
      <div className="absolute top-[-20%] left-1/2 w-[120vw] max-w-[1400px] h-[800px] -translate-x-1/2 opacity-60 pointer-events-none select-none mix-blend-screen z-0 overflow-hidden blur-[100px]">
