...
import type { TileForgeTile } from '../superanimation';
import OverlayLayers from './OverlayLayers';
import { WebGLTileForge } from '../rendering/webgl/WebGLTileForge';
...
const TILE_FORGE_TILES = TILES as readonly TileForgeTile[];
    ...
    >
      <style
        dangerouslySetInnerHTML={{
          __html: `
            ...
            @keyframes state-label {
              0% { content: "STATE: FORMING"; color: inherit; }
              27.499% { content: "STATE: FORMING"; color: inherit; }
              27.5% { content: "STATE: UNSTABLE"; color: rgba(255,75,62,0.8); }
              36.25% { content: "STATE: UNSTABLE"; color: rgba(255,75,62,0.8); }
              36.251% { content: "STATE: FORMING"; color: inherit; }
              53.749% { content: "STATE: FORMING"; color: inherit; }
              53.75% { content: "STATE: UNSTABLE"; color: rgba(255,75,62,0.8); }
              63.75% { content: "STATE: UNSTABLE"; color: rgba(255,75,62,0.8); }
              63.751% { content: "STATE: FORMING"; color: inherit; }
              83.749% { content: "STATE: FORMING"; color: inherit; }
              83.75% { content: "STATE: STABLE"; color: rgba(110,231,168,0.8); }
              94.375% { content: "STATE: STABLE"; color: rgba(110,231,168,0.8); }
              94.376% { content: "STATE: FORMING"; color: inherit; }
              100% { content: "STATE: FORMING"; color: inherit; }
            }
          `,
        }}
      />
      ...
      >
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute top-[-16px] left-[-2px] font-mono text-[8px] text-[rgba(244,240,232,0.26)]">
            00
          </div>
          <div className="absolute top-[-16px] right-[-4px] font-mono text-[8px] text-[rgba(244,240,232,0.26)]">
            18
          </div>
          <div className="absolute bottom-[-16px] left-[-4px] font-mono text-[8px] text-[rgba(244,240,232,0.26)]">
            18
          </div>

          <WebGLTileForge
            tiles={TILE_FORGE_TILES}
            className="sa-webgl-tile-field"
          />
        </div>
      </div>
    </div>
