...
export function IntroSection() {
  return (
    <section className="relative py-[64px] px-6 md:px-[24px]">
      {/* Futuristic background gradient bleeding downwards */}
      <div className="absolute top-0 -bottom-[300px] left-0 right-0 z-0 pointer-events-none flex justify-center items-center opacity-60">
        <div className="absolute w-[1200px] h-[800px] bg-gradient-to-b from-purple-600/40 via-pink-600/50 to-red-600/60 blur-[180px] rounded-full mix-blend-screen translate-y-[10%]" />
        <div className="absolute w-[800px] h-[500px] bg-gradient-to-tr from-purple-500/60 via-pink-500/70 to-red-500/80 blur-[140px] rounded-full mix-blend-screen opacity-90 translate-y-[20%]" />
      </div>
