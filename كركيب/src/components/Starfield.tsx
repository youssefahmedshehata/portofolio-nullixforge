...
export function Starfield() {
  const { layerA, layerB, layerC, layerD, dustParticles } = useMemo(() => {
    return {
      layerA: generateStars(60, [0.5, 1.2], ['#FFF1D2', '#FFE6B0', '#FFFFFF'], [0.1, 0.5]),
      layerB: generateStars(35, [1.0, 1.8], ['#FFF1D2', '#DFA55B', '#FFFFFF'], [0.3, 0.7]),
      layerC: generateStars(15, [1.5, 2.5], ['#FFFFFF', '#DFA55B'], [0.5, 0.9]),
      layerD: generateStars(8, [2.0, 3.5], ['#FFF1D2', '#FFC46B', '#FF6A2A'], [0.4, 0.8]),
      dustParticles: generateDust(25)
    };
  }, []);
  ...
  return (
    <>
      ...
      {/* Container for organization. z-[-10] is the base. */}
      <div className="fixed inset-0 z-[-10] pointer-events-none" data-layer="genesis-dawn-field" data-future="webgl-shader-ready">
        ...
        <div className="absolute inset-0" data-layer="cinematic-starfield">
        ...
        <div data-layer="system-orbits" className="absolute inset-0 overflow-hidden">
          {/* Subtle orbital ring */}
          <div 
        ...
        <div data-layer="volumetric-rays" className="absolute inset-0 overflow-hidden mix-blend-screen opacity-60">
          <div 
        ...
        <div data-layer="light-dust" className="absolute inset-x-0 bottom-[10vh] h-[40vh] pointer-events-none">
