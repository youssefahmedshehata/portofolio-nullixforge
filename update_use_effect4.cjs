...
const newUseEffect = 
  ...
  "      css += `  27.499% { opacity: 0.92; border-color: rgba(255,255,255,0.10); }\\n`;\n" +
  "      css += `  ${tile.redAStart - 0.001}% { opacity: 0.92; border-color: rgba(255,255,255,0.10); }\\n`;\n" +
  "      css += `  ${tile.redAStart}% { opacity: 0.94; border-color: rgba(255,75,62,0.24); }\\n`;\n" +
  "      css += `  34.5% { opacity: 0.94; border-color: rgba(255,75,62,0.24); }\\n`;\n" +
  "      css += `  34.999% { opacity: 0.92; border-color: rgba(255,255,255,0.10); }\\n`;\n" +
  "      css += `  35% { opacity: 0.92; border-color: rgba(255,255,255,0.10); }\\n`;\n" +
  "      css += `  50% { opacity: 0.95; border-color: rgba(255,255,255,0.10); }\\n`;\n" +
  "      css += `  51.499% { opacity: 0.95; border-color: rgba(255,255,255,0.10); }\\n`;\n" +
  "      css += `  ${tile.redBStart - 0.001}% { opacity: 0.95; border-color: rgba(255,255,255,0.10); }\\n`;\n" +
  "      css += `  ${tile.redBStart}% { opacity: 0.96; border-color: rgba(255,75,62,0.18); }\\n`;\n" +
  "      css += `  58.5% { opacity: 0.96; border-color: rgba(255,75,62,0.18); }\\n`;\n" +
  "      css += `  58.999% { opacity: 0.95; border-color: rgba(255,255,255,0.10); }\\n`;\n" +
  "      css += `  59% { opacity: 0.95; border-color: rgba(255,255,255,0.10); }\\n`;\n" +
  "      css += `  76% { opacity: 1.0; border-color: rgba(255,255,255,0.10); }\\n`;\n" +
  "      css += `  77.499% { opacity: 1.0; border-color: rgba(255,255,255,0.10); }\\n`;\n" +
  "      css += `  ${tile.greenStart - 0.001}% { opacity: 1.0; border-color: rgba(255,255,255,0.10); }\\n`;\n" +
  "      css += `  ${tile.greenStart}% { opacity: 1.0; border-color: rgba(110,231,168,0.26); }\\n`;\n" +
  "      css += `  89% { opacity: 1.0; border-color: rgba(110,231,168,0.26); }\\n`;\n" +
  "      css += `  89.999% { opacity: 1.0; border-color: rgba(255,255,255,0.10); }\\n`;\n" +
  "      css += `  90% { opacity: 1.0; border-color: rgba(255,255,255,0.10); }\\n`;\n" +
