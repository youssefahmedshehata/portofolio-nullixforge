...
const shapeB = [
  ...
  {c:2, r:2}, {c:3, r:2}, {c:4, r:2} // Extra 3 outside to make 18
];
...
fs.writeFileSync('/app/applet/src/components/generated_tiles.json', JSON.stringify(res, null, 2));
console.log("Successfully wrote generated_tiles.json");
